    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="flex flex-col items-center justify-center gap-3 border-t border-base-300 pt-6">
            <div className="text-xs text-zinc-500 font-medium uppercase tracking-wider">Or continue with</div>
            <div className="w-full flex justify-center">
              <GoogleLogin
                onSuccess={(res) => {
                  loginWithGoogle(res.credential).then((result) => {
